...
To see what code files are available and what specific arguments they require, use the 'bolt -l'. For example, to create a serial batch script for the CP2K-code use:
