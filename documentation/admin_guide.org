...
+ =serial time format= :: The format for the serial job time will be printed in the job submission script. 
Valid values are: 'hms' - hh:mm:ss; 'hours' - integer hours; 'seconds' - integer seconds.
